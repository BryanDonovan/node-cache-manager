 ...
 *   should not be returned *immediately* if found in any cache. If the function returns true, it will be
 ...
 *
 *   If an underlying cache specifies its own isReturnableValue function, that function will
 *   be used instead of the multiCaching's _isReturnableValue function.
 */
